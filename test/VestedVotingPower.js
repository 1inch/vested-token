...
const vestings = ["0xA8cCF2B22A4fD872e533AfbBc21664Ee6dC1c262"];
...
describe("VestedVotingPower", async function () {
    before(async function () {
        ...
        this.VestedVotingPower = await VestedVotingPower.new(
            V1INCH_ADDR,
            ST1INCH_ADDR
        );
    });
    ...
    it("should register vestings and calculate voting power correctly", async function () {
        ...
        expect(
            await this.VestedToken.balanceOf(
                "0x46aBbc9fc9d8E749746B00865BC2Cf7C4d85C837"
            )
        ).to.be.bignumber.equal(ether("1875000"));
        expect(
            await this.VestedVotingPower.votingPowerOf(
                "0x46aBbc9fc9d8E749746B00865BC2Cf7C4d85C837"
            )
        ).to.be.bignumber.lt(ether("130000"));
    });
});
